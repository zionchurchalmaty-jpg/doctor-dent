  ...
  return (
    <section className="bg-[#1D4ED8] py-16 px-6 text-center">
      ...
      <p className="text-blue-100 mb-8 max-w-2xl mx-auto text-[16px]">
        Свяжитесь с нами, и мы поможем создать вашу страницу и настроить
        продвижение
      </p>
      <div className="flex flex-wrap justify-center gap-4">
        <a
          href="tel:+77052793078"
          className="bg-white text-[#2563EB] hover:bg-gray-50 rounded-xl px-8 h-12 font-medium inline-flex items-center justify-center gap-2 transition-all duration-200 hover:-translate-y-1 hover:shadow-lg active:scale-95 cursor-pointer"
        >
